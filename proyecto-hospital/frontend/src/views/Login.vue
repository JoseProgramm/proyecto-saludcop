  ...
  <div class="limiter">
    <div class="container-login100">
      <div class="wrap-login100">
        ...
        >
          <span class="login100-form-title"> Login Salud COP</span>
          <div class="wrap-input100 validate-input">
            ...
            <small v-if="errorCampos" class="text-danger">El usuario es requerido</small>
          </div>
          <div class="wrap-input100 validate-input">
            <input
              class="input100"
            ...
            />
            <small v-if="errorCampos" class="text-danger">La clave es requerida</small>
            <small v-if="errorClave" class="text-danger">La clave debe ser minimo de 5 caracteres</small>
            <span class="focus-input100"></span>
            <span class="symbol-input100">
          ...
          <div class="container-login100-form-btn">
            <button :disabled="botonDeshabilitado" class="login100-form-btn">
              Iniciar sesión <span><i class="fas fa-lock"></i> </span>
            </button>
          </div>
          <div class="text-center p-t-136 mt-4">
            <router-link class="txt2" to="/registro">
      ...
      axios
        ...
        .then((response) => {
          if (response.data.msg.includes("correctamente")) {
            this.botonDeshabilitado = false;
            alertify.set("notifier", "position", "top-right");
            alertify.success("Usuario autenticado éxitosamente!");
            localStorage.setItem(
              "admin-login",
              response.data.usuarioObtenido[0].id
            );
            this.login = {
              usuario: "",
              clave: "",
